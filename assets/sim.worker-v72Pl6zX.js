...
\r
    ...
    if (sumCoefT > 0.0) {\r
        ...
        // 0.5 is strictly stable for Jacobi diffusion in 2D\r
        tempWrite[idx] = currentT + 0.5 * (targetT - currentT);\r
    } else {\r
